...

{
    ...
    content: `
        ...
        <p>Despite the work and community response, I eventually deleted the project—including the YouTube channel. I couldn't bring my vision to life with the tools available, and I was going through things personally. Looking back, I regret deleting it, especially the YouTube archive.</p>
        
        <div style="background: linear-gradient(135deg, #5a3d3d 0%, #3d2828 100%); padding: 24px; border-radius: 12px; border-left: 4px solid #ff6b6b; margin: 24px 0;">
            <div style="display: flex; align-items: flex-start; gap: 12px;">
                <span style="font-size: 24px;">💭</span>
                <div>
                    <p style="color: #fff; font-weight: 600; margin: 0 0 8px 0;">What Made V1 Unsustainable</p>
                    <p style="color: rgba(255,255,255,0.9); margin: 0; line-height: 1.6;">It wasn't just technical limitations—it was the gap between what I knew the archive could be and what I could actually build at the time. The manual approach worked, but it couldn't scale to match the vision in my head.</p>
                </div>
            </div>
        </div>
        
        <h2>Why Now Works</h2>
        <p>The tools finally exist to build what I originally envisioned. With AI-assisted development, I can design the exact experience I want and actually build it.</p>
